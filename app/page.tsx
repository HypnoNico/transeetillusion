    ...
    <main className="bg-black text-white overflow-x-hidden">
      ...
      <section className="py-28 px-6 text-center max-w-4xl mx-auto">
        <Reveal>
          ...
          <p className="text-white/70 mt-4 text-lg">
            Chaque intervention mêle humour, surprise et immersion,
            dans un cadre respectueux et sécurisé, adapté à ton public.
          </p>
        </Reveal>
      </section>
      ...
      <section className="py-32 text-center px-6">
        <Reveal>
          ...
          <a
            href="/contact"
            className="inline-block mt-10 px-10 py-4 rounded-full bg-blue-500 hover:bg-blue-600 transition font-semibold"
          >
            Demander un devis
          </a>
        </Reveal>
